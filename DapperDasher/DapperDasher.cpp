...
int main()
{
	...
	while (!WindowShouldClose())
	{
		...
		{
			//lose the game
			DrawText("Game Over!",windowDimension[0]/4,windowDimension[1]/2,40, BLACK);
		}
		else if (scarfyData.pos.x>=finishLine)
		{
			//win the game
			DrawText("Victory!", windowDimension[0] / 4, windowDimension[1] / 2, 40, BLACK);
		}
		else
		{
